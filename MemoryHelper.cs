...
namespace SaveManagerEldenRing
{
    ...
    {
        Process process;
        public MemoryHelper(Process TargetProcess)
        {
...
namespace Memory.Utils
{
    ...
    {
        public static uint OffsetCalculator(SaveManagerEldenRing.MemoryHelper TargetMemory, uint BaseAddress, int[] Offsets)
        {
        ...
        internal static ulong OffsetCalculator(MemoryHelper helper, ulong quitoutBaseAddr, int[] offsetQuitout)
        {
